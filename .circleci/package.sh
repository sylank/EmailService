...
rm $CONFIG_DIR/main_template.template
rm $CONFIG_DIR/secrets.json

aws s3 cp s3://artifactory.levendulabalatonmaria.info/credentials/$APP_NAME/main_template.template $CONFIG_DIR/main_template.template
